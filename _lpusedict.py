...
class BaseMutableLazyProperty(lazyproperty, immutable=False):
    ...
    def __init_subclass__(cls, immutable: bool, use_instance_dict: bool, prefix: str = '', private_var_name: str = '', **init_subclass_kwargs):
        return super().__init_subclass__(immutable, use_instance_dict, prefix, private_var_name, **init_subclass_kwargs)
